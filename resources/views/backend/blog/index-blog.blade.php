                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    @if($blog->status == 1)
                                    <a href="#" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#blog_status_{{$blog->id}}"><i class="fa fa-spinner"></i> Pending</a>
                                    @elseif($blog->status == 2)
                                    <a href="#" class="btn btn-success btn-xs" data-toggle="modal" data-target="#blog_status_{{$blog->id}}"><i class="fa fa-check"></i> Approved</a>
                                    @endif
                                </td>
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" class="form-control">
                                                        ...
                                                        <option value="2" @if( $blog->status == 2 ) selected @endif >Approved</option>
                                                    </select>
