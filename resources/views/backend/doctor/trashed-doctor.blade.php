...
@section('title','Trashed Doctor')
@section('content')
<div id="content" class="content">
    <ol class="breadcrumb float-xl-right">
        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
        <li class="breadcrumb-item active">Trashed Doctor</li>
    </ol>
        ...
        <div class="col-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">Trashed Doctor List</h4>
                    ...
                    <table id="data-table-default" class="table table-striped table-bordered table-td-valign-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    @if($doctor->status == 1)
                                    <a href="javascript:;" class="btn btn-danger btn-xs"><i class="fa fa-spinner"></i> Pending</a>
                                    @elseif($doctor->status == 2)
                                    <a href="javascript:;" class="btn btn-success btn-xs"><i class="fa fa-check"></i> Approved</a>
                                    @endif
                                </td>

                                <td>
                                    
                                    <a id="restore" href="{{route('doctor.restore',$doctor->id)}}" class="btn btn-warning btn-xs"><i class="fa fa-undo"></i> Restore</a>
                                    <a id="delete" href="{{route('doctor.destroy',$doctor->id)}}" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>
                                </td>
                            </tr>
