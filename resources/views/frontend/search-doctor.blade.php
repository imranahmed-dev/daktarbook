...
<section class="teachers-list pt-15 pb-15 aos-init aos-animate" data-aos="fade-up">
    ...
    <div class="container teachers-profile-box py-4" data-aos="fade-up">
        <div class="row">
            <div class="col">
                <h6 class="alert alert-success"> অনুসন্ধান ফলাফল ( {{$doctors->count()}} )</h6>
            </div>
        </div>
        <div class="row">
           ...
           @foreach($doctors as $doctor)
            ...
            <div class="teachers-profile">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="@if(!empty($doctor->image)) {{asset($doctor->image)}} @else {{asset('defaults/avatar/avatar.png')}} @endif" alt="" class="teachers-profile-img teachers-profile-img-res img-fluid">
                        </div>
